...
namespace ApiAgroDTE.Clases
{
    public class Factura
    {
        ...
        public string crearFactura(JsonElement Encabezado, JsonElement Detalles, JsonElement ReferenciaOp, Boolean RefFlag, JsonElement DscRcgGlobalOp, Boolean DscRcgFlag, int nuevoFolio, string archxml,string T33F)
        {
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            string queryUpdateInicial = "UPDATE factura SET fchemis_factura = '" + FchEmis + "',rutrecep_factura = '" + RUTRecep + "',rznsocrecep_factura = '" + RznSocRecep + "',cmnarecep_factura = '" + CmnaRecep + "',mnttotal_factura = '" + MntTotal + "',detalle_factura = '" + DetalleFactura + "'"; 
            string queryUpdateRef = ",folioref_factura = '" + FolioRef + "',tipo_dteref_factura = '"+ TpoDocRef + "'";
            string queryUpdateFinal = " WHERE folio_factura = '" + Folio + "'";
            string queryUpdate = "";
